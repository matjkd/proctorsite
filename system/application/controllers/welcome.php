...
class Welcome extends MY_Controller {
    ...
    function lease_rate_results() {
        ...
        if ($run == 'yes') {
            ...
            $data['quote_results'] = $this->calculator->quote($data['capital_type'], $data['amount_type'], $data['interest_type'], $data['calculate_by'], $data['payment_type'], $data['payment_frequency'], $data['initial'], $data['regular']);
