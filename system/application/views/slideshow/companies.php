<img src="<?=base_url()?>images/titles/our_partners.png"/>
<div id="partners_container">

<div class="multiple" id="partners">
	<ul>
		...
		<li ><img width="200px" height="60px" src="<?=base_url()?>images/logos/companies/redbox.png"/></li>
	</ul>
</div>
