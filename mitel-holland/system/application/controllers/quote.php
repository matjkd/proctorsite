...
class Quote extends My_Controller {
	...
	function main()
	{
		...
		$data['title'] = ' Managed Service Offerte tool';
		$this->load->vars($data);
	...
	function results()
	{
		...
		$this->form_validation->set_rules('quote_ref', 'referentieveld', 'trim|required');
		$this->form_validation->set_rules('amount_type', 'type bedrag', 'trim|required');
		$this->form_validation->set_rules('calculate_by', 'rekenmethode', 'trim|required');
		...
		$this->form_validation->set_rules('initial', 'initiële betaling', 'trim|integer|required');
		$this->form_validation->set_rules('regular', 'reguliere betaling', 'trim|integer|required');
...
function is_logged_in()
	{
		...
		{
			$this->session->set_flashdata('message', 'U bent niet ingelogd');
			redirect('user/login');
