<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="body">
  ...
  <tr> 
	...
	echo "<strong>$clientname</strong><BR><BR>	
			...
			$postcode <BR><BR>
			$date<BR><BR>
			<strong>Your Ref:</strong> $ioorderref<br/>
<strong>Our Ref:</strong> $iotitle ";
		  ...
		  <STRONG>Completion Date</STRONG> - $deliverydate<BR><BR>
...
<div class="footer2"> 
  <p><em>If Colourlink at the Customer’s request has carried out 
    any extra works or incurred any delays beyond the control of Colourlink that are not included in the substance or extent of the agreed 
  ...
  <BR>
    <BR>
   <?php require_once('address.inc'); ?></div>
</div>
