...
// some variable settings: Even though it says purchase order a lot, thats just a techinicallity, might ignore that cos it works
...
<form action='<?php $PHP_SELF ?>'  method='post' name= '$PHP_SELF' >
  ...
  <input name="purchaseordernumberform" type="hidden" value="<?php echo $newordernumber; ?>">
  ...
  <table width="700" border="0" class="border">
    ...
    <tr>
      ...
      <td class="database"><?php if ($ioemailto==NULL)
																	{
																	echo $mainemail;
																	$emailto = $mainemail;
																	}
...
<?php } ?>
  ...
  //end of while
        ...
        <tr> 
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td align="right" class="body"><table width="700" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td width="522">&nbsp;</td>
        <td width="178" >Total: £ <?php echo "$totalcost"; ?></td>
      </tr>
    </table>
    <strong></strong>:</td>
          <td class="body"><strong></strong></td>
        </tr>
      </table>
<br>
<br>
...
<a href='production.php?ordernumber=$newordernumber&&formaction=view'>Back to production form</a><BR>
<a href=productionreport2.php?internalordernumber=$newordernumber target='_blank'>Print production sheet</a><BR><BR>
<a href=installationreport.php?internalordernumber=$newordernumber target='_blank'>Print installation report</a><BR><BR>
";
if ($xy=="yes")
{
echo "<a href=ackreport.php?internalordernumber=$newordernumber target='_blank'>Print acknowledgement</a> <BR><BR>

<a href=emailack.php?internalordernumber=$newordernumber target='_blank'>email acknowledgement to $ioemailto</a> <BR><BR>
