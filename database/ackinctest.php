<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="body">
  ...
  <tr>
	...
	$sql = "SELECT DISTINCT tableref FROM ordertables WHERE  tableordernumber='$internalordernumber' AND tablecategory='AF' ORDER BY tablenumber";
...
<div class="footer"> <em>Please check this order acknowledgement carefully and 
