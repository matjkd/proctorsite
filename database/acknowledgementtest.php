...
<?php } ?>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0" class="database">
	...
	$sql = "SELECT * FROM ordertables WHERE tableordernumber='$internalordernumber' ORDER BY tablenumber";
		$result = mysql_query($sql)
		or die ("no data");
		$totalcost = 0;
		while ($row = mysql_fetch_array($result))
...
<a href=productionreport.php?internalordernumber=$newordernumber target='_blank'>Print production sheet</a><BR><BR>
";
if ($xy=="yes")
{
